...
public class HazeShaderProgram extends ShaderProgram {
    ...
    public HazeShaderProgram(Context context) {
        super(context, ShaderCodes.VERTEX_SHADER_HAZE, ShaderCodes.FRAGMENT_SHADER_HAZE);
