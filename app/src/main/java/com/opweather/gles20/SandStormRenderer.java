...
import com.opweather.gles20.objects.SandParticleShooter;
import com.opweather.gles20.objects.SandParticleSystem;
...
public class SandStormRenderer implements Renderer {
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        this.texture = TextureHelper.loadTexture(this.mContext, R.mipmap.sand);
    }
